...
if 'VCAP_SERVICES' in os.environ:
    ...
    if 'speech_to_text' in vcap:
        ...
        speechToTextUrl = speechToTextCreds.get('url'+'/v1/recognize?model=ja-JP_BroadbandMod')
    ...
    speechToTextUrl = os.environ.get('SPEECHTOTEXT_URL'+'/v1/recognize?model=ja-JP_BroadbandMod')
...
@app.route('/api/speech-to-text/v1/recognize?model=ja-JP_BroadbandModel', methods=['POST'])
def getTextFromSpeech():
    tts_kwargs = {
            'username': speechToTextUser,
            'password': speechToTextPassword,
            'iam_apikey': speechToTextIAMKey,
            'url': speechToTextUrl+'v1/recognize?model=ja-JP_BroadbandMode'
    }
