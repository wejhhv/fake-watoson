...
if 'VCAP_SERVICES' in os.environ:
    ...
    if 'speech_to_text' in vcap:
        ...
        speechToTextUrl = speechToTextCreds.get('url')+'/v1/models/ja-JP_BroadbandModel'
    ...
    speechToTextUrl = os.environ.get('SPEECHTOTEXT_URL')+'/v1/models/ja-JP_BroadbandModel'
